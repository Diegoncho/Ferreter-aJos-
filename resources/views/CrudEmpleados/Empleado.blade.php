    ...
    <div class="panel panel-default" style="min-width: 800px">
        ...
        <div class="flexbox md-5">
            <div class="function-crud flex align-items-center">
                <form  action="{{ route('empleado') }}" class="form-search pull-left" method="GET" role="search">
                    <div class="form-group">
                        <input type="text" class="form-control" name="name" placeholder="Buscar empleado">
                    </div>
                    <button type="submit" class="btn btn-primary" >Buscar <i class="icon-search"></i></button>
                </form>

                <a href="{{ route('empleadoAdd') }}" class="btn btn-success" style="margin:7px 0px;">
                    <i class="icon-play_for_work "></i> Nuevo Registro
                </a>
            </div>

            <p>Hay <b>{{ $Empleados->total() }}</b> empleados</p>
        </div>
