...
@section('content')
    ...
    <div class="panel panel-default" style="min-width: 800px">
        <div class="panel-heading"><b>Listado de facturas</b></div>
        ...
        <div class="flexbox md-5">
            ...
            <p>Hay <b>{{ $VistaFacturas->total() }}</b> facturas</p>
        </div>
        ...
        <table class="table">
            ...
            @foreach($VistaFacturas as $row)
                <tr data-id="{{ $row->id }}">
                    ...
                    <td>{{ $row->telefono }}</td>
                    <td>
                        <a href="#" onclick="javascript:AbrirImpresion();" class="btn btn-info"><span class="icon-visibility"></span></a>
